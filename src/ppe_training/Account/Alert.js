        ...
        <>
            {
                isShow &&
                <>
                   <div className= "absolute z-10 bg-black-50 top-0 bottom-0 left-0 right-0"></div> 
                   <div className= "z-20 absolute left-0 right-0 bg-white absolute-y p-3 border border-gray-200 shadow-lg rounded-md">
                       {props.message}
